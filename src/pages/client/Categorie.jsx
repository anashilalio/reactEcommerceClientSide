...
const Categorie = ({ onCategoryClick }) => {
  ...
  return (
    <div className="bg-gray-400 ml-12">
      {loading ? (
        ...
        <div className="w-full shadow-xl rounded-xl" >
          <div className="fixed w-64 overflow-y-auto top-16 rounded-xl shadow-xl h-130  pb-10 px-8 custom-scrollbar" style={{}}>
            <h2 className="text-center text-2xl font-bold mt-4 mb-8">Categories</h2>
            {categories.map((ctg) => (
              <Link
                key={ctg.categorie}
                to={`/products/${ctg.categorie}`}
                onClick={() => {
