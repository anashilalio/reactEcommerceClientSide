        ...
        <div className='shadow-md rounded-xl py-4 px-4 bg-gray-50'>
            <div className=' '>
                <div className='flex gap-8 items-center'>
                    <img src={`http://localhost/ecommerce%20project/client/${photo}`}  alt="" className='size-10 bg-cover rounded-full ' />
                ...
                <div className='flex items-center mt-2'>
                            {[...Array(5)].map((e , index)=>{
                                return <FaStar className={`${rate>index ? 'text-green-500' : 'text-black'} `} />
                            })}
