...
const Cart = () => {
  ...
  useEffect(()=>{
    const deleteProduct = async()=>{
      const response = await axios.post("http://localhost/ecommerce%20project/client/deleteProductFromCart.php",{deleteThatProduct : deleteThatProduct });      
    ...
    <div className='mt-20 flex justify-around'>
      ...
      {listItems.map((er)=>{
        ...
        return <div className='w-full grid grid-cols-5  h-44 ml-8 shadow pt-5'>
          ...
          <div className='mt-12 relative' onClick={()=>setDeleteThatProduct(er.productid)} ><IoIosRemoveCircle className='text-red-500 text-3xl cursor-pointer'/> 
      ...
      <Link to="/Payment"><div className='bg-black text-white rounded-2xl w-56 mx-auto mt-8 shadow-lg cursor-pointer
